...
restLevels = [Level.Level_01.data, Level.Level_02.data, Level.Level_04.data, Level.Level_08.data, Level.Level_12.data, Level.Level_13.data, Level.Level_14.data]