...
restLevels = [Level.Level_02.data, Level.Level_04.data, Level.Level_08.data, Level.Level_12.data, Level.Level_13.data, Level.Level_14.data, Level.Level_20.data]